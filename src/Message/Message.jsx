...
import image_Mes from "../../assets/image/WhatsApp Image 2023-03-21 at 14.28.16 1.webp";
        ...
        <div className="contentMain_Mes container">
          <div className="row">
            <div className="content_Mes col-lg-6">
              <h1 className="title_Mes">Message</h1>
              <h3 className="subtile_Mes">CHEF</h3>
              <p className="img_Mes">
                <img src={icon_wel} alt="" />
              </p>
              <p className="pargraph_Mes">
            ...
            <div className="image_Mes col-lg-6">
